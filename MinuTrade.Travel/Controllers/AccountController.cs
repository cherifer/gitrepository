...
using MinuTrade.Travel.Filters;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(Users user)
        {
            ...
            try
            {
                ...
                {
                    Users us = objContext.User.SingleOrDefault(m => m.Email == user.Email);
                    if (us != null)
                    {
                        if (us.Cpf.Trim() == user.Cpf)
                        {
                            FormsAuthentication.SetAuthCookie(user.Email, false);
                            return RedirectToAction("Index", "PacoteViagem");
                        }
