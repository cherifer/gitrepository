...
using MinuTrade.Travel.Entity;

namespace MinuTrade.Travel.Providers
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            //    HttpContext.Current.Cache.Add(username, new MyMembershipProvider(user.UserId, user.Username, user.Email), null, Cache.NoAbsoluteExpiration, FormsAuthentication.Timeout,
